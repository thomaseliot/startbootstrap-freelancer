...
#if FB_SHIFT == 4
#define LaneCases(a)	    LaneCases4(0,a)
#endif

#if FB_SHIFT == 3
#define LaneCases(a)	    LaneCases2(0,a)
#endif
	       ...
	       int	yRot)
{
     ...
     */
    stipEnd = stip + (INT32)stipStride * (INT32)stipHeight;
    modulus (- yRot, stipHeight, stipY);
    s = stip + (INT32)stipStride * (INT32)stipY;
	      ...
	      int	yRot)
{
	...
	while (widthTmp)
	{
		...
		w = widthTmp;
	    widthTmp -= w;
	    fbBltOne (stip + (INT32)stipY * (INT32)stipStride,
		      stipStride,
		      sx,

		      dst + (INT32)y * (INT32)dstStride,
		      dstStride,
		      x,
		      dstBpp,
