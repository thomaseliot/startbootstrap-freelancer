...
/* whether to include 32bpp support */
#ifndef FBNO32BIT
#define FB_32BIT
#endif
/* whether to include 24bpp support */
#ifndef FBNO24BIT
#define FB_24BIT
#endif
/* whether to include 16bpp support */
#ifndef FBNO16BIT
#define FB_16BIT
#endif
/* whether to include 8bpp support */
#ifndef FBNO8BIT
#define FB_8BIT
#endif
/* whether to include transparent buffer support */
#ifndef FBNOTRANS
#define FB_TRANS
#endif

#ifndef USE_INDEXED_COLOR_BLENDING
#define FB_DIRECT_COLOR_BLENDING
#endif

#if ALTIA_ALPHA_BLENDING
#define USE_FB_BLEND
#endif
...
#define FbSelectPatternPart(xor,o,t)	((t)((xor) >> (FbPatternOffset (o,t) << 3)))
...
#if FB_SHIFT == 4
#define FbLaneCase(n,a)   FbLaneCase2(n,(CARD8 *) (a),0)
#endif

#if FB_SHIFT == 3
#define FbLaneCase(n,a)   FbLaneCase1(n,(CARD8 *) (a),0)
#endif
...
#define fbGetAlphasPixmap(pDrawable) ((PixmapPtr)(((DrawablePtr)((pDrawable)))->alphas))
...
#ifdef FB_NO_WINDOW_PIXMAPS
#define fbDrawableEnabled(pDrawable) TRUE
#else
...
typedef void	(*fbAlphaCopyProc) (DrawablePtr	pSrcDrawable,
			            DrawablePtr	pDstDrawable,
...
int
fbInitAlphaBlending (ScreenInfo *screenInfo,
                     unsigned long r,
                     unsigned long g,
                     unsigned long b);

void
fbGetAlphaBlending (unsigned long * rshift, unsigned long * rmask,
                    unsigned long * gshift, unsigned long * gmask,
                    unsigned long * bshift, unsigned long * bmask);

typedef struct
{
    CARD32 (*b)(CARD32, CARD32);
} BLEND_FUNCTION;

extern const BLEND_FUNCTION fbblend[];

#define FBBLEND(_alphaValue,_foreground,_background) \
    fbblend[(_alphaValue)].b((CARD32)(_foreground),(CARD32)(_background))
#endif /* USE_FB_BLEND */
#endif /* _FB_H_ */
