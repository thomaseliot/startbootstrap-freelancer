 ...
 * can_drv.h
	...
	for use with the ATmega64C1 device. Use of this file is subject to Atmel's 
...
// Definition checks for correct configuration
// Oscillator frequency
#ifndef FOSC
#  error  You must define FOSC in compiler options for your project
#endif
...
// Set baudrate registers for given oscillator frequency (FOSC)
...
#   define Can_bit_timing(mode)  (can_fixed_baudrate(mode))
    ...
    // ----------
#define CAN_PORT_IN     PINC // edited for ATmega64C1
#define CAN_PORT_DIR    DDRC // edited for ATmega64C1
#define CAN_PORT_OUT    PORTC // edited for ATmega64C1
#define CAN_INPUT_PIN   3 // edited for ATmega64C1
#define CAN_OUTPUT_PIN  2 // edited for ATmega64C1
    // ----------
...
#define SJW_MAX     4
    // ----------
//#define NB_MOB       15
#define NB_MOB       6 // edited for ATmega64C1 
...
typedef enum {MOB_0,  MOB_1, MOB_2,  MOB_3,  MOB_4,  MOB_5} can_mob_t;// edited for ATmega64C1
    // ----------
