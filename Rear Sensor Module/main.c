...
{	
	...
	*/
	...
	// Rate: 50Hz
	xTaskCreate(vCoolingSetTask, "FAN_ST", configMINIMAL_STACK_SIZE,
		NULL, COOLING_SET_TASK_PRIORITY, NULL);
		
	// Fan speed update task
	// Rate: 100Hz	
	xTaskCreate(vCoolingUpdateTask, "FAN_UP", configMINIMAL_STACK_SIZE,
		NULL, COOLING_UPDATE_TASK_PRIORITY, NULL);
