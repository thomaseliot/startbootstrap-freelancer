 ...
 * @author justinr2
 */
public class BooleanCanTranslatorInterface extends CanPayloadTranslator {

    String name;

    BooleanCanTranslatorInterface(WriteableCanMailbox payload, int expectedMask, String name) {
        super(payload, 1, expectedMask);
        this.name = name;
    }
    
    BooleanCanTranslatorInterface(ReadableCanMailbox payload, int expectedMask, String name) {
        super(payload, 1, expectedMask);
        this.name = name;
    }
